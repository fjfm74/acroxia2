  ...
  return (
    <>
      <SEOHead
        ...
        description="Sube tu contrato de alquiler (PDF, DOCX o foto) y detecta cláusulas ilegales en 2 minutos con IA. Basado en la LAU 2026. 100% confidencial."
        canonical="https://contratoalquiler.com/analizar-gratis"
        ...
        jsonLd={{
          ...
          operatingSystem: "Web",
          description:
            "Sube tu contrato de alquiler y recibe un análisis gratuito de cláusulas potencialmente ilegales con IA",
          offers: {
            "@type": "Offer",
            price: "0",
            priceCurrency: "EUR",
            description: "Análisis preview gratuito en 2 minutos",
          },
          potentialAction: {
            "@type": "UseAction",
            target: "https://contratoalquiler.com/analizar-gratis",
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 bg-muted pt-28 pb-12">
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            {step === "wizard" && (
              <FadeIn>
                <ContractTypeWizard onResult={handleWizardResult} onBack={() => setStep("selector")} />
              </FadeIn>
            )}

            {step === "not_supported" && (
              <FadeIn>
                <ContractNotSupported type={notSupportedType} onBack={() => setStep("selector")} />
              </FadeIn>
            )}
                ...
                <FadeIn>
                  <div className="text-center mb-8">
                    <span className="inline-block px-4 py-1 bg-primary/10 text-primary text-sm font-medium rounded-full mb-4">
                      100% Gratuito · Resultado en 2 min
                    </span>
                    <h1 className="font-serif text-4xl md:text-5xl font-semibold text-foreground mb-4">
                      Analiza tu contrato ahora
                    </h1>
                    <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                      Descubre si tu contrato de alquiler contiene cláusulas que podrían ser ilegales o abusivas según
                      la LAU.
                    </p>
                            ...
                            `}
                              ...
                              <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
                                ...
                                <div className="flex items-start gap-3 ml-8">
                                  ...
                                  >
                                    Declaro que <strong>soy parte del contrato</strong> y tengo interés legítimo en
                                    analizarlo. He leído la{" "}
                                    <Link
                              ...
                              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm">
                                ...
                                <ul className="text-blue-700 space-y-1 list-disc list-inside">
                                  ...
                                  <li>
                                    Carácter <strong>informativo</strong>, no es asesoramiento legal
                                  </li>
                    ...
                    <FadeIn delay={0.3}>
                      <Card className="bg-foreground text-background">
                        <CardContent className="pt-6">
                          ...
                          <p className="text-background/70 text-sm">— María G., Madrid</p>
                        </CardContent>
                      </Card>
                    </FadeIn>
                  </div>
      ...
      <ComingSoonModal audience="propietario" open={landlordModalOpen} onOpenChange={setLandlordModalOpen} />
    </>
  );
};
