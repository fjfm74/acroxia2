...
const AdminBlogNew = () => {
  ...
  return (
    <>
      ...
      <AdminLayout 
        title="Nuevo Post" 
        description="Genera contenido con IA o escribe manualmente"
      >
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-1 space-y-6 order-2 lg:order-1">
            <Card className="border-border">
              ...
              <CardContent className="space-y-4">
                ...
                <p className="text-xs text-muted-foreground text-center">
                  La IA buscará temas relevantes del sector inmobiliario
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <Textarea
                    id="prompt"
                    placeholder="Ej: Escribe sobre los derechos del inquilino ante una subida de alquiler abusiva..."
                    value={customPrompt}
            ...
            {/* Preview Panel - hidden on mobile when no content */}
            {post.content && (
