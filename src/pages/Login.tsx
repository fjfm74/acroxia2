...
const Login = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Iniciar Sesión | ContratoAlquiler</title>
        <meta name="description" content="Accede a tu cuenta de ContratoAlquiler para analizar tus contratos de alquiler." />
        <link rel="canonical" href="https://contratoalquiler.com/login" />
        <meta property="og:title" content="Iniciar Sesión | ContratoAlquiler" />
        <meta property="og:description" content="Accede a tu cuenta para analizar contratos de alquiler con IA." />
        <meta property="og:url" content="https://contratoalquiler.com/login" />
